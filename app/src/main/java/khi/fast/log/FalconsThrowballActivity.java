...
public class FalconsThrowballActivity extends AppCompatActivity {
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        mStoriesDatabaseReference =mFirebaseDatabase.getReference().child("falconsThrowball");
        mStoriesStorageReference =firebaseStorage.getReference().child("falcons_teamThrowball");
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("falconsThrowball");
        ...
        mHouseDatabaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new TeamAdapter(FalconsThrowballActivity.this, getmMatch());
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    adapter = new TeamAdapter(FalconsThrowballActivity.this, images);
