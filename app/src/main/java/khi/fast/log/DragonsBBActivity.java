...
public class DragonsBBActivity extends AppCompatActivity {
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        mStoriesDatabaseReference =mFirebaseDatabase.getReference().child("dragonsBB");
        mStoriesStorageReference =firebaseStorage.getReference().child("dragons_teamBB");
        Button =(ImageView) findViewById(R.id.backButton);

        Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(DragonsBBActivity.this,TeamBB.class);
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("dragonsBB");
        ...
        mHouseDatabaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new TeamAdapter(DragonsBBActivity.this, getmMatch());
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    adapter = new TeamAdapter(DragonsBBActivity.this, images);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(DragonsBBActivity.this,Teams.class);
        startActivity(i);
        finish();
    }
    @Override
