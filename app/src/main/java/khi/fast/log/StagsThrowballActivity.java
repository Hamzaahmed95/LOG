...
public class StagsThrowballActivity extends AppCompatActivity {

    private static final String TAG = "StagsThrowballActivity";
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        mStoriesDatabaseReference =mFirebaseDatabase.getReference().child("stagsThrowball");
        mStoriesStorageReference =firebaseStorage.getReference().child("stags_teamThrowball");
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("stagsThrowball");
        ...
        mHouseDatabaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new TeamAdapter(StagsThrowballActivity.this, getmMatch());
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    adapter = new TeamAdapter(StagsThrowballActivity.this, images);
