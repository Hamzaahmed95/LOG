...
public class HuntersBadmintonActivity extends AppCompatActivity {
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        mStoriesDatabaseReference =mFirebaseDatabase.getReference().child("hunterBadminton");
        mStoriesStorageReference =firebaseStorage.getReference().child("hunter_teamBadminton");
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("hunterBadminton");
        ...
        mHouseDatabaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new TeamAdapter(HuntersBadmintonActivity.this, getmMatch());
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    adapter = new TeamAdapter(HuntersBadmintonActivity.this, images);
