...
public class DragonsThrowballActivity extends AppCompatActivity {

    private static final String TAG = "DragonsThrowballActivity";
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        stags.setBackgroundResource(R.drawable.bg_gradient8);
        ...
        mStoriesDatabaseReference =mFirebaseDatabase.getReference().child("dragonsThrowball");
        mStoriesStorageReference =firebaseStorage.getReference().child("dragons_teamThrowball");
        Button =(ImageView) findViewById(R.id.backButton);

        Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(DragonsThrowballActivity.this,TeamsThrowball.class);
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("dragonsThrowball");
        ...
        mHouseDatabaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new TeamAdapter(DragonsThrowballActivity.this, getmMatch());
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    adapter = new TeamAdapter(DragonsThrowballActivity.this, images);
