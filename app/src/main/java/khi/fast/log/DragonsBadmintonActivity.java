...
public class DragonsBadmintonActivity extends AppCompatActivity {
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        mStoriesDatabaseReference =mFirebaseDatabase.getReference().child("dragonsBadminton");
        mStoriesStorageReference =firebaseStorage.getReference().child("dragons_teamBadminton");
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("dragonsBadminton");
        ...
        mHouseDatabaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new TeamAdapter(DragonsBadmintonActivity.this, getmMatch());
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    adapter = new TeamAdapter(DragonsBadmintonActivity.this, images);
