...
public class DragonsVolleyballActivity extends AppCompatActivity {

    private static final String TAG = "DragonsVolleyballActivity";
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        stags.setBackgroundResource(R.drawable.bg_gradient7);
        ...
        mStoriesDatabaseReference =mFirebaseDatabase.getReference().child("dragonsVolleyball");
        mStoriesStorageReference =firebaseStorage.getReference().child("dragons_teamVolleyball");
        Button =(ImageView) findViewById(R.id.backButton);

        Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(DragonsVolleyballActivity.this,TeamsVolleyball.class);
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("dragonsVolleyball");
        ...
        mHouseDatabaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new TeamAdapter(DragonsVolleyballActivity.this, getmMatch());
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    adapter = new TeamAdapter(DragonsVolleyballActivity.this, images);
