...
public class StagsBadmintonActivity extends AppCompatActivity {

    private static final String TAG = "StagsBadmintonActivity";
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        mStoriesDatabaseReference =mFirebaseDatabase.getReference().child("stagsBadminton");
        mStoriesStorageReference =firebaseStorage.getReference().child("stags_teamBadminton");
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("stagsBadminton");
        ...
        mHouseDatabaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new TeamAdapter(StagsBadmintonActivity.this, getmMatch());
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    adapter = new TeamAdapter(StagsBadmintonActivity.this, images);
