...
public class StagsVolleyballActivity extends AppCompatActivity {

    private static final String TAG = "StagsVolleyballActivity";
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        mStoriesDatabaseReference =mFirebaseDatabase.getReference().child("stagsVolleyball");
        mStoriesStorageReference =firebaseStorage.getReference().child("stags_teamVolleyball");
        Button =(ImageView) findViewById(R.id.backButton);

        Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(StagsVolleyballActivity.this,TeamsVolleyball.class);
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("stagsVolleyball");
        ...
        mHouseDatabaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new TeamAdapter(StagsVolleyballActivity.this, getmMatch());
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    adapter = new TeamAdapter(StagsVolleyballActivity.this, images);
