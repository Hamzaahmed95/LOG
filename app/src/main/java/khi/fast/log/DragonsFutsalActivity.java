...
public class DragonsFutsalActivity extends AppCompatActivity {
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        mStoriesDatabaseReference =mFirebaseDatabase.getReference().child("dragonsFutsal");
        mStoriesStorageReference =firebaseStorage.getReference().child("dragons_teamFutsal");
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("dragonsFutsal");
        ...
        mHouseDatabaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new TeamAdapter(DragonsFutsalActivity.this, getmMatch());
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    adapter = new TeamAdapter(DragonsFutsalActivity.this, images);
