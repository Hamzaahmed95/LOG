...
public class DiresVolleyballActivity extends AppCompatActivity {
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        mStoriesDatabaseReference =mFirebaseDatabase.getReference().child("diresVolleyball");
        mStoriesStorageReference =firebaseStorage.getReference().child("dires_teamVolleyball");
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("diresVolleyball");
        ...
        mHouseDatabaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new TeamAdapter(DiresVolleyballActivity.this, getmMatch());
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    adapter = new TeamAdapter(DiresVolleyballActivity.this, images);
