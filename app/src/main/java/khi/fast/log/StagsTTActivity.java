...
public class StagsTTActivity extends AppCompatActivity {

    private static final String TAG = "StagsTTActivity";
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        stags.setBackgroundResource(R.drawable.bg_gradient9);
        ...
        mStoriesDatabaseReference =mFirebaseDatabase.getReference().child("stagsTT");
        mStoriesStorageReference =firebaseStorage.getReference().child("stags_teamTT");
        Button =(ImageView) findViewById(R.id.backButton);

        Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(StagsTTActivity.this,TeamsTT.class);
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("stagsTT");
        ...
        mHouseDatabaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new TeamAdapter(StagsTTActivity.this, getmMatch());
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    adapter = new TeamAdapter(StagsTTActivity.this, images);
