...
public class JaguarsVolleyballActivity extends AppCompatActivity {
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        mStoriesDatabaseReference =mFirebaseDatabase.getReference().child("jaguarVolleyball");
        mStoriesStorageReference =firebaseStorage.getReference().child("jaguar_teamVolleyball");
        Button =(ImageView) findViewById(R.id.backButton);

        Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(JaguarsVolleyballActivity.this,TeamsVolleyball.class);
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("jaguarVolleyball");
        ...
        mHouseDatabaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new TeamAdapter(JaguarsVolleyballActivity.this, getmMatch());
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    adapter = new TeamAdapter(JaguarsVolleyballActivity.this, images);
